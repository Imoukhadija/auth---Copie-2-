...
<head>
    ...
    <title>{{ __('Connexion') }} - {{ __('Système de gestion de l\'assurance automobile') }}</title>
    <style>
        * {
            padding: 0;
            margin: 0;
        ...
        .field input.is-invalid {
            box-shadow: rgba(0, 0, 0, 0) 0px 0px 0px 0px,
                rgba(0, 0, 0, 0) 0px 0px 0px 0px,
                rgba(0, 0, 0, 0) 0px 0px 0px 0px,
                rgba(220, 53, 69, 0.5) 0px 0px 0px 1px,
                rgba(0, 0, 0, 0) 0px 0px 0px 0px,
                rgba(0, 0, 0, 0) 0px 0px 0px 0px,
                rgba(0, 0, 0, 0) 0px 0px 0px 0px;
        }
                ...
                <div class="formbg-outer">
                    <div class="formbg">
                        <div class="formbg-inner padding-horizontal--48">
                            ...
                            <h3><a rel="dofollow">{{ __('LOGIN SAHAM GROUP FIKRI') }}</a></h3>
                            <br></br>
                    ...
                    <div class="footer-link padding-top--24">
                        ...
                        <div class="listing padding-top--24 padding-bottom--24 flex-flex center-center">
                            <span><a href="#">© {{ config('app.name', 'Laravel') }}</a></span>
                            <span><a href="#">{{ __('Contact') }}</a></span>
                            <span><a href="#">{{ __('Privacy & terms') }}</a></span>
                        </div>
                    </div>
                </div>
            </div>
